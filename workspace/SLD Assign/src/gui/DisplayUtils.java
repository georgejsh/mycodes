...
public class DisplayUtils {
	 ...
	 * @param wrtScreen
	 *            - true if to be positioned in center of screen false if to be
	 *            positioned in center of shell's parent
	 */
	 ...
	 *            - shell under consideration
	 * @param wrtScreen
	 *            - true if to be positioned with respect to screen false if to
	 *            be positioned wirh respect to shell's parent
	 * @param widthratio
	 *            - (Range 0 - 1)
	 * @param heightratio
	 *            - (Range 0 - 1)
	...
	public static void positionShell(Shell shell, boolean wrtScreen,
	...
	public static void setAllEnabled(Control control, boolean enabled) {
		...
		if (children.length == 0) {
			...
			if (control instanceof Group) {
				((Group) control).setForeground(new Color(Display.getDefault(),
						204, 204, 204));
			}
		}
